...
function DarkmodeToggle({
    ...
    return (
        <>
            <input type="checkbox" id="darkmode-toggle" checked={darkmode} onChange={() => setDarkmode(prevState => !prevState)}/>
            <label htmlFor="darkmode-toggle">
                <svg version="1.1" className="sun" x="0px" y="0px" viewBox="0 0 496 496">
                ...
                <svg version="1.1" className="moon"  x="0px" y="0px" viewBox="0 0 49.739 49.739">
