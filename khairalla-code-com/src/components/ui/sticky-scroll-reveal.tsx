...
export const StickyScroll = ({
  ...
  const [activeStyle] = React.useState( parseStyleString(JSON.parse(content[activeCard].attributes ?? "{}")));
  ...
  return (
    ...
    >
      <div className="div relative flex items-start px-4">
        <div className="max-w-2xl">
          {content.map((item, index) => {
              ...
              return (
                <div style={childStyles} key={item.title + index} className="my-20">
                  <motion.h2
                    initial={{
                      opacity: 0,
                    }}
      ...
      <div
        style={{...activeStyle, background: backgroundGradient } }
        className={cn(
