...
function register_carousel() {
	...
	register_post_meta('carousel', 'slide_ids', array(
		'show_in_rest' => true,
		'show_in_graphql' => true,
		'single'       => true,
		'type'         => 'string',
	...
	register_post_meta('carousel', 'initial_index', array(
		'show_in_rest' => true,
		'show_in_graphql' => true,
		'single'       => true,
		'type'         => 'number',
	...
	register_post_meta('carousel', 'attributes', array(
		'show_in_rest' => true,
		'show_in_graphql' => true,
		'single'       => true,
		'type'         => 'string',
	...
	add_action( 'graphql_register_types', function() {
		register_graphql_field( 'Carousel', 'slide_ids', [
			'type' => 'String',
		...
		register_graphql_field( 'Carousel', 'initial_index', [
			'type' => 'Number',
		...
		register_graphql_field( 'Carousel', 'attributes', [
			'type' => 'String',
