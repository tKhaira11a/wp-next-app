...
(function (factory) {
    ...
    ParticleNetwork.prototype.init = function () {
        ...
        this.setStyles(this.canvasDiv, { 'max-height': 'inherit' });
        ...
        if (this.options.interactive) {
            ...
            this.canvas.addEventListener('mousemove', function (e) {
                ...
                this.mouseParticle.y = e.clientY - this.canvas.offsetTop - 110;
            }.bind(this));
...
export function ParticleCanvasInit(canvasDiv, options) {
    return new ParticleNetwork(canvasDiv, options)
}