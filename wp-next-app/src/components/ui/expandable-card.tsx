...
export default function ExpandableCard(props: ExpandableCardsProp) {
            ...
            <AnimatePresence>
                {active && typeof active === "object" ? (
                    <div className="fixed inset-0  grid place-items-center z-[100]">
                        <motion.button
                            key={`button-${active.title}-${id}-${Uuid}`}
                            layout
                            initial={{
                                opacity: 0,
                            }}
                            ...
                            <motion.div layoutId={`image-${card.title}-${id}`}>
                                <img
                                    ...
                                    className={"rounded-lg object-cover object-top " + (
                                        props.listMode === "List"
                                        ? "h-40 w-40 md:h-14 md:w-14"
                                        : "h-60 w-full"
                                    )}
                                />
                            </motion.div>
                            <div className={(props.listMode === "Grid"
